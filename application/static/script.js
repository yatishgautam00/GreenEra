...
// This is new code date : 12 feb 2024

const predictButton = document.getElementById('predictButton');
const resultBox1 = document.getElementById('result-img-box');
const resultBox2 = document.getElementById('result-box');

// document.addEventListener('DOMContentLoaded', function() {
  // Check if visibility state is stored in local storage
  // const isVisible = localStorage.getItem('isVisible');
  
  // Apply the appropriate visibility state to the elements
 

  // Update the visibility state when user interacts with elements
...
//     resultBox1.classList.remove('OnPredict-hide');
//     resultBox2.classList.remove('OnPredict-hide');
//   });
//   predictButton.addEventListener('click', function() {
...
//  if (resultBox1.classList.contains("OnPredict-hide")) {
//   resultBox1.classList.remove('OnPredict-hide');
//       resultBox2.classList.remove('OnPredict-hide');
//   }
// });
//new codeing
// Get the view solution button and popup container
const viewSolutionBtn = document.getElementById('viewSolutionBtn');
const popupContainer = document.getElementById('popupContainer');

// Add event listener to the view solution button
...
document.getElementById('popupContainer').addEventListener('click', function() {
  ...
  document.getElementById('popupContainer').classList.remove('hidden222');
});
